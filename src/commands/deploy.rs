...
//         let project = ZKSProject::from(Project::builder()
//             .paths(ProjectPathsConfig::builder().build_with_root(args.contract.clone().context("no contract path")?))
...
//                     contract_path = args.contract.context("no contract path provided")?,
